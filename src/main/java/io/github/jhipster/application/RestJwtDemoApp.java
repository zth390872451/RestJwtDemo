...
public class RestJwtDemoApp {

    private static final Logger log = LoggerFactory.getLogger(RestJwtDemoApp.class);

    private final Environment env;

    public RestJwtDemoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes RestJwtDemo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RestJwtDemoApp.class);
